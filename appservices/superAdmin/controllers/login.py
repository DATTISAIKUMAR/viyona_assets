...
def error_function(request):
    try:
        ...
        return templates.TemplateResponse('loginfiles.html', {'request': request, 'message': message})
...
async def super_admin_sinup(email:str,password:str,request:Request):
    try:
        ...
        return "success"
        # return templates.TemplateResponse('super_admin.html', {'request': request, 'message': message})
    except Exception as e:
        message="exception has occured.."
        return templates.TemplateResponse('super_admin.html', {'request': request, 'message': message})
